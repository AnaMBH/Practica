...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Mostrar la ventana emergente correspondiente
    document.getElementById("popular-link").addEventListener("click", function(event) {
        closeAllFeatures();
        document.getElementById("myPopular").style.display = 'block';
    });

    document.getElementById("rated-link").addEventListener("click", function(event) {
        closeAllFeatures();
        document.getElementById("myTop-rated").style.display = 'block';
    });

    document.getElementById("coming-link").addEventListener("click", function(event) {
        closeAllFeatures();
        document.getElementById("myComing-soon").style.display = 'block';
    });

    document.getElementById("billboard-link").addEventListener("click", function(event) {
        closeAllFeatures();
        document.getElementById("myBillboard").style.display = 'block';
    });
...
/* Fondo colores dentro "Features" */

document.addEventListener("DOMContentLoaded", function () {
    
    const items = document.querySelectorAll(".details-features");
    
    items.forEach((item) => {
        const text = item.querySelector(".movie-genre");
        const score = item.querySelector(".user-score");

        // Cambiar fondo de '.movie-name' según el género
        ...
        // Cambiar fondo de '.user-score' según la puntuación
        ...
        if (!isNaN(scoreValue)) {
            ...
            score.style.backgroundColor = "#ADD8E6"; // Fondo azul si no se indica puntuación
        }
    });
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    listItems.forEach((item) => {
        ...
        if (!isNaN(ratingValue)) {
            ...
            rating.style.backgroundColor = "#ADD8E6"; // Fondo azul si no se indica puntuación
        }    
    });
});
